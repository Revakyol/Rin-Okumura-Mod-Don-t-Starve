...
return {
	...
	ANNOUNCE_CHARLIE_ATTACK = "I don't think I can kill this.",
	ANNOUNCE_COLD = "I didn't even think I COULD get cold anymore.",
	ANNOUNCE_HOT = "Maaan....it's hooot!",
	...
	ANNOUNCE_MOSQUITOS = "Aaah! Get lost!",
	...
	ANNOUNCE_WORMHOLE = "Let's not do that again.",
	...
	{
		[1] = "Oh crap",
		[2] = "I think I'm losing control a bit here.",
		[3] = "Oops!",
		[4] = "I made a fire, again.",
		[5] = "Gah! I didn't mean to do that!",
	...
	ANNOUNCE_DAMP = "Great, it's raining.",
	ANNOUNCE_WET = "I should probably get out of this rain.",
	ANNOUNCE_WETTER = "This sucks!",
	ANNOUNCE_SOAKED = "I hate the rain.",
	...
	DESCRIBE =
	{
        ...
        {
        	GENERIC = "Shiny.",
        	DEAD = "Dead, but still shiny.",
        },
        GLOMMERWINGS = "These would look awesome on a helmet!",
        GLOMMERFUEL = "What even is this?",
        BELL = "Dingalingaling.",
        STATUEGLOMMER = 
        {	
        	GENERIC = "Kinda looks like a fly on a shoe.",
        	EMPTY = "I don't know if I should have done that.",
    	},
		...
		ARMORGRASS = "I hope there aren't bugs in this.",
		...
		BEEFALO =
		{
			...
			GENERIC = "That is one big cow...thing.",
		...
		BISHOP = "You don't look religious to me.",
		BLOWDART_FIRE = "Do I even have a use for firedarts?",
		BLOWDART_SLEEP = "Just don't breathe in.",
		BLOWDART_PIPE = "Good practice for my birthday cake!",
		BLUEAMULET = "Cool as ice!",
		BLUEGEM = "Blue. Like me. Inside and outside.",
		...
		CARROT = "I should find more ingredients.",
		CARROT_COOKED = "Mushy.",
		...
		EVERGREEN =
		{
			...
			BURNT = "I feel like I could have prevented that.",
			CHOPPED = "Take that, nature!",
			GENERIC = "I wonder if any of these are Greenmen?",
		},
		EVERGREEN_SPARSE =
		{
			BURNING = "What a waste of wood.",
		...
		EYEPLANT = "That is one of the weirdest plants I have ever seen.",
		FARMPLOT =
		{
		...
		GHOST = "Finally! Something more normal, for me at least.",
		...
		GOLDNUGGET = "I could buy so many sukiyaki buns with this!",
		GRASS =
		{
		...
		HAMBAT = "I should just eat this instead.",
        ...
        WATERMELONICLE = "Homemade icepops!",
		...
		NIGHTSWORD = "I should use this with my other sword!",
		...
		PIGMAN =
		{
			...
			WEREPIG = "Well there's something you don't see everyday.",
		},
		...
		POOP = "That's just nasty.",
		FERTILIZER = "I never thought I would use one of these.",
		...
		RABBIT =
		{
			GENERIC = "It's so fluffy!",
			HELD = "You kinda remind me of Usamuro.",
		},
		RABBITHOLE = 
		{
		...
		SPOILED_FOOD = "Ugh, gross!",
		STATUEHARP = "What has happened to the head?",
		STATUEMAXWELL = "Psh. Jerk.",
		STINGER = "Looks sharp!",
		...
		TALLBIRD = "Why's it so big?",
		TALLBIRDEGG = "Will it hatch?",
		TALLBIRDEGG_COOKED = "So good!",
		TALLBIRDEGG_CRACKED =
		{
			COLD = "Brrrr!",
		...
		TALLBIRDNEST =
		{
			GENERIC = "I could make so many omelettes with that egg!",
		...
		TURF_DIRT = "Why am I collecting dirt?",
		TURF_FOREST = "A chunk of ground.",
		TURF_GRASS = "Grassy.",
		TURF_MARSH = "Basically mud.",
		TURF_ROAD = "Hastily cobbled stones.",
		TURF_ROCKY = "Kinda like cement, but not.",
		TURF_SAVANNA = "Drier grass.",
		TURF_WOODFLOOR = "These are floorboards.",
		TURKEYDINNER = "I've never had oven-roasted turkey before!.",
		...
		WORMHOLE =
		{
			GENERIC = "Whoa, a worm, huh?",
			OPEN = "Do I have to go in there?",
		},
